...
arg_model_trainer_map = {
    ...
    'resnet': ResNetOracleTrainer,
    'deep_factorized': DeepFactorizedOracleTrainer
}
...
def main() -> int:
    ...
    # set up logging
    filename = f'oracle-{configs["model_type"]}-{date.today()}'
    ...
    # get trainer
    trainer_type = arg_model_trainer_map[configs['model_type']]
